  ...
  return (
    <div className='flex fixed top-0 z-50 bg-white/90 backdrop-blur-lg  w-full px-4'>
      <nav className="justify-between w-full flex items-center h-24 max-w-7xl mx-auto">  
        <Link to="hero" spy={true} smooth={true} offset={50} duration={500} className="flex gap-2 flex-row items-center cursor-pointer"><img src={star} alt="stella savoy logo" className="h-8 w-8"/> <span className='playfair w-full text-2xl font-semibold text-theme-gray cormorant flex items-center gap-1'>Stella Savoy</span></Link>
